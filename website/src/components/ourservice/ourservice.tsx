        ...
        <div className={common.centeredText}>
          ...
          Our core does not only deliver technology to run a mobile core network but also includes 
            ...
            <div className={styles.ourServiceFeatures}> 
              <li><Yes /> Upgrades / evolution</li>
              <li><Yes /> Operations (incl. 24/7)</li>
              <li><Yes /> Support</li>
              <li><Yes /> Application layer</li>
              <li><Yes /> Orchestration</li>
              <li><Yes /> Operating systems</li>
              <li><Yes /> Infrastructure / hardware</li>
              <li><Yes /> Networking</li>
              <li><Yes /> Data centre / power</li>
            </div>
          </div>
        </div>
      </div>
...
function Yes() {
  return (
      <Check color="#4CAF50" margin-right="2px" />
  );
}
