    ...
    <div className={`${common.section} ${styles.section}`}>
      <div className={`${common.container} `}>
        ...
        >
          ...
          >
            TESTING!!!! -- Join a league of global telco front-runners in their
            pursuit of growth and efficiency. By connecting to our borderless
            core, you will simplify operations, reduce cost by 30-70% and get
            access to a product marketplace to help you differentiate and build
            new revenue streams.
          </Translate>
        </div>
