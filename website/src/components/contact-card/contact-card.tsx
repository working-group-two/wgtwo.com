...
const emailIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.3 14.5">
    <path
      d="m1 13.4 6.9-6m13.3 6-6.9-6M2 .5h18.3c.8 0 1.5.7 1.5 1.5v10.5c0 .8-.7 1.5-1.5 1.5H2c-.8 0-1.5-.7-1.5-1.5V2C.5 1.2 1.2.5 2 .5zM.9 1l9.4 8.1c.5.4 1.2.4 1.7 0L21.3 1"
      fill="none"
      stroke="#141414"
