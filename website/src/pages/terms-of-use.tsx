          ...
          <div className={styles.container}>
            <div className={styles.termscontent}>
              ...
              <p>
                ...
                AS
                (以下当社)および本契約を履行するための提携会社（以下「提携会社」といいます。）の提供する本サービス（第2条に定義）のご利用にあたり、ユーザーの皆様に遵守していただかなければならない事項及び当社とユーザーの皆様との間の権利義務関係が定められております。本サービスをご利用になる方は、本規約に同意する前に、必ず全文お読み下さいますようお願い致します。
              </p>
            </div>
            ...
            <div className={styles.termscontent}>
              <h2 className={styles.titleHeader}>本人確認</h2>
              <p>
